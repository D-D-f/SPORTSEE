        ...
        <>
            <ResponsiveContainer className="responsiveContainerChart" minWidth={300} width={"80%"} height={"30%"}>
                <BarChart
                    ...
                    barGap={5}
                >
                    <Legend content={<CustomizedLegend />} verticalAlign='top' align='right' iconType='circle' wrapperStyle={{marginTop: '-13px'}} formatter={(value) => <span style={{color: "var(--fontColorChart"}}>{value}</span>} />
